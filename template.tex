...
\newcommand{\divider}
{
	\begin{center}
	\begin{tikzpicture}
		\draw[dashed, black] (0.25*\textwidth, 0) -- (0.75*\textwidth, 0);
...
coltitle=blue!50!black,fonttitle=\upshape\bfseries,
...
coltitle=green!25!black,fonttitle=\upshape\bfseries,
sharp corners = all,boxrule = 0pt,
underlay = {\draw[step=5mm,
...
coltitle=gray!50!black,fonttitle=\upshape\bfseries,
sharp corners = all,boxrule = 0pt,
underlay = {\draw[step=5mm,
